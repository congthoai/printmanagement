...
<html>
	...
	<body>
		...
		<form action="<c:url value='/quan-tri/don-gia/danh-sach?/page=${model.page }&limit=${model.limit }'/>" id="formSubmit" method="get">
									...
									<div class="table-btn-controls">
										<div class="pull-right tableTools-container">
											<div class="dt-buttons btn-overlap btn-group">
												<c:url var="createpricelistURL" value="/quan-tri/don-gia/chinh-sua"/>
												<a flag="info"
												   class="dt-button buttons-colvis btn btn-white btn-primary btn-bold" data-toggle="tooltip"
												   title='Thêm bài viết' href='${createpricelistURL}'>
															<span>
												...
												<tbody>
													<c:forEach var="item" items="${model.listResult}">
														<tr>
															...
															<td>
																<c:url var="updatepricelistURL" value="/quan-tri/don-gia/chinh-sua">
																	<c:param name="id" value="${item.id}"/>															
																</c:url>																
																<a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
																   title="Cập nhật bài viết" href='${updatepricelistURL}'><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
																</a>
				...
				$
						.ajax({
							...
							success : function(result) {
								window.location.href = "${pricelistURL}?message=delete_success";
							},
