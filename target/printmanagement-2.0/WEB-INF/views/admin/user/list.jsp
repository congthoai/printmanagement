...
<html>
	...
	<body>
		...
		<form action="<c:url value='/quan-tri/tai-khoan/danh-sach?/page=${model.page }&limit=${model.limit }'/>" id="formSubmit" method="get">
										...
										<div class="pull-right tableTools-container">
											<div class="dt-buttons btn-overlap btn-group">
												...
												<a class="DTTT_button btn btn-white btn-primary  btn-bold"
													...
													data-original-title="Print view"><span><i
												...
												<tbody>
													<c:forEach var="item" items="${model.listResult}">
														<tr>
															...
															<%-- <td><img id='idimage' width="150" src="<c:url value='/resources/images/jisoo.jpg' />"></td>	 --%>
															<td>${item.fullName}</td>
															<td>${item.userName}</td>
															<td>*********</td>
															<td>
