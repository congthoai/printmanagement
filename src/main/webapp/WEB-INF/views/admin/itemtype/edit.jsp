...
<c:url var="edititemtypeURL" value="/quan-tri/loai-san-pham/chinh-sua" />
		...
		<div class="main-content-inner">
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<ul class="breadcrumb">
					...
					<li><a href="${itemtypeURL}?">Danh sách</a></li>
					...
					<div class="col-xs-12">
						...
						<form:form class="form-horizontal" role="form" id="formSubmit" modelAttribute="model">
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Mã loại sản phẩm</label>
								<div class="col-sm-9">
	...
	<script>
		...
		function addNew(data) {
			$.ajax({
						...
						success : function(result) {
							window.location.href = "${edititemtypeURL}?id="
		...
		function updateNew(data) {
			$.ajax({
				...
				dataType : 'json',
				success : function(result) {
					window.location.href = "${edititemtypeURL}?id=" + result.id
